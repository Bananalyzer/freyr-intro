document.addEventListener('DOMContentLoaded', () => {
  ...
  messageForm.addEventListener('submit', (e) => {
    ...
    // Create new li for the message; add .messages-item to make the class of each li "messages-item"
    const newMessage = document.createElement('li');
    newMessage.classList.add('messages-item');
  ...
  // Add projects dynamically to section from github:
  fetch('https://api.github.com/users/Hannahlyzer/repos')        
    ...
    .then((repositories) => {
      ...
      projectList.className = 'list-of-things vertical-list';
